    ...
    <div className="p-8 max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium mt-1">Configure global operational and financial parameters</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-sm space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-sm font-black text-slate-900 dark:text-slate-100 uppercase tracking-tight">Standard Working Hours</h3>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-slate-50 dark:bg-slate-950/50 rounded-2xl border border-slate-100 dark:border-slate-800">
              ...
              />
              <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase">Hours / month (Default: 176h)</p>
            </div>
            <p className="text-xs text-slate-500 leading-relaxed italic">
              * This number is used to calculate the value of personnel working hours based on monthly salary.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-sm space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-sm font-black text-slate-900 dark:text-slate-100 uppercase tracking-tight">Revenue Model</h3>
          ...
          <div className="space-y-4">
            ...
            >
              <option value="PACKAGE">Based on Package Value (Subscription)</option>
              <option value="SRO_HOURS">Based on actual SRO hours</option>
            </select>
            ...
            {settings.revenueMode === "SRO_HOURS" && (
              <div className="p-4 bg-indigo-50/50 dark:bg-indigo-900/10 rounded-2xl border border-indigo-100 dark:border-indigo-900/30 animate-in slide-in-from-top-2">
                <label className="text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase block mb-1">Unit price per SRO hour (VND)</label>
                <input 
                  type="number"
      ...
      <div className="p-6 bg-blue-50 dark:bg-blue-900/10 rounded-[32px] border border-blue-100 dark:border-blue-900/30 flex gap-4 items-start">
        ...
        <div>
          <p className="text-sm font-black text-blue-900 dark:text-blue-200 uppercase tracking-tight">Important Note</p>
          <p className="text-xs font-medium text-blue-700 dark:text-blue-400 leading-relaxed mt-1">
            Changes to standard hours and revenue models will directly impact all financial reports, performance reports, and trend charts immediately. Please ensure you have consulted with the accounting department before adjusting.
          </p>
        </div>
      </div>
    </div>
